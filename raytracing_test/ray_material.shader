...
uniform int mat:hint_range(0, 3) = 0;
...
//uniform int array_size = 4;
//varying float sphere_array[4];

const vec4 sphere3 = vec4(5.0,5.50,-10.0,3.0);

vec3 rand(float t){
    float r = fract(sin(dot(vec2(t,0.0) ,vec2(12.9898,78.233))) * 43758.5453);
	float g = fract(sin(dot(vec2(-t,0.0) ,vec2(12.9898,78.233))) * 43758.5453);
	float b = fract(sin(dot(vec2(0.0,t) ,vec2(12.9898,78.233))) * 43758.5453);
	return vec3(r,g,b);
}
/*
...
void Trace(vec3 ray_origin,vec3 ray_direction,vec3 ray_energy,out vec3 bestHit_position,out float bestHit_distance,out vec3 bestHit_normal,out vec3 bestHit_albedo,out vec3 bestHit_specular)
{
	...
	/* cnostructing arrays repeatedly slows machine down
	int numSpheres = 7;
	//vec4 spheres[7]={sphere1,sphere3,vec4(-sphere_o.xyz,5.0),vec4(-sphere_o1.xyz,5.0),vec4(-sphere_o2.xyz,5.0),vec4(-sphere_o3.xyz,5.0),vec4(-sphere_o4.xyz,5.0)};
	//vec3 sphere_albedo[7]={sphere1.xyz,vec3(0.0,1.0,0.0),vec3(1.0, 0.78, 0.34),sphere_o1,vec3(0.20, 1.1, 0.80),vec3(1.0, 0.3, 0.84),vec3(0.0, 0.0, 0.0)};
	//vec3 sphere_specular[7]={sphere1.xyz,vec3(0.04,0.04,0.04),vec3(1.0, 0.78, 0.34),sphere_o1,vec3(0.20, 1.1, 0.50),vec3(1.0, 0.3, 0.84),vec3(0.7, 0.7, 0.7)};
    IntersectGroundPlane(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal,bestHit_albedo,bestHit_specular, groundplane.xyz, groundplane.a,vec3(0.80,0.80,0.80),vec3(0.06));
	for (int i = 0; i < numSpheres; i++){
		//IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, spheres[i],sphere_albedo[i],sphere_specular[i]);
		//IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, spheres[i],vec3(0.0,0.0,0.0),vec3(0.6));
		IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, spheres[i],vec3(0.80),vec3(0.04));
	}
	*/
	//
	...
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, sphere3,vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o.xyz,5.0),vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o1.xyz,3.0),vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o2.xyz,5.0),vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o3.xyz,5.0),vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o4.xyz,5.0),vec3(0.0),vec3(0.6));
	//IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o5.xyz,2.0),vec3(0.3f, 0f, 1f),vec3(0.3f, 0f, 1.0));
	//IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o7.xyz,10.0),vec3(0.0157, 0.3882,0.0275),vec3(0.0157, 0.3882,0.0275));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o8.xyz,7.0),vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o9.xyz,10.0),vec3(0.0),vec3(0.6));
	IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o10.xyz,10.0),vec3(0.0),vec3(0.6));
	//IntersectSphere(ray_origin, ray_direction, bestHit_position, bestHit_distance, bestHit_normal, bestHit_albedo, bestHit_specular, vec4(-sphere_o11.xyz,7.0),vec3(0.20, 0.78, 0.84),vec3(0.20, 0.78, 0.84));
	*/
